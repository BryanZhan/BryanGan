...
checkpoint = torch.load("D:/chip/ChipGAN-pytorch/saved_models/genA.pth.tar", map_location=config.DEVICE)
gen_B.load_state_dict(checkpoint["state_dict"])

# Create Data loader.
root_A = 'D:/chip/wash_ink_dataset_fin/horse/trainA'     # root_A is the directory you save your real world images.
